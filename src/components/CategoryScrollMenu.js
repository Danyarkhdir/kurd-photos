          ...
          {selected &&
            selected.map((item) => (
              <p
                ...
                className={`xs:text-base xs:px-3 text-gray-400 md:text-2xl dark:hover:text-white hover:text-black xs:py-3 md:px-10  md:py-3 dark:active:text-white active:text-black inline-block cursor-pointer
              ${
                item.current &&
